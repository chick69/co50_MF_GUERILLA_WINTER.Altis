...
[
	...
	["Quadbike (Civilian)", "C_Quadbike_01_F", 6000, "vehicle", "SKIPSAVE"],
	["Quadbike (NATO)", "B_Quadbike_01_F", 6500, "vehicle", "SKIPSAVE"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 6500, "vehicle", "SKIPSAVE"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 6500, "vehicle", "SKIPSAVE"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 6500, "vehicle", "SKIPSAVE"],
	...
	["MB 4WD (Guerilla)", "I_C_Offroad_02_unarmed_F", 9000, "vehicle", "SKIPSAVE"],
	...
	["Truck Camo", "B_G_Van_01_transport_F", 8000, "vehicle", "SKIPSAVE"],
	...
	["Van Cargo", "C_Van_02_vehicle_F", 10000, "vehicle", "SKIPSAVE"],
	["Van Transport", "C_Van_02_transport_F", 10000, "vehicle", "SKIPSAVE"],
	["Van Ambulance", "C_Van_02_medevac_F", 15000, "vehicle", "SKIPSAVE"],
	["Van Repair", "C_Van_02_service_F", 20000, "vehicle", "SKIPSAVE"],

	["HEMTT Tractor", "B_Truck_01_mover_F", 40000, "vehicle"],
	["HEMTT Resupply", "B_Truck_01_ammo_F", 50000, "vehicle"],
	//["HEMTT Box", "B_Truck_01_box_F", 50000, "vehicle"],
	["HEMTT Transport", "B_Truck_01_transport_F", 60000, "vehicle"],
	["HEMTT Covered", "B_Truck_01_covered_F", 70000, "vehicle"],
	...
	["Tempest Device", "O_Truck_03_device_F", 40000, "vehicle"],
	["Tempest Resupply", "O_Truck_03_ammo_F", 50000, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 60000, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 70000, "vehicle"],
	...
	["Zamak Transport", "I_Truck_02_transport_F", 45000, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 50000, "vehicle"],
...
[
	["Prowler (Doorless)", "B_CTRG_LSV_01_light_F", 15000, "vehicle", "SKIPSAVE"],
	["Prowler", "B_T_LSV_01_unarmed_F", 20000, "vehicle", "SKIPSAVE"],
	["Prowler HMG", "B_T_LSV_01_armed_F", 60000, "vehicle", "SKIPSAVE"],
	["Qilin", "O_T_LSV_02_unarmed_F", 20000, "vehicle", "SKIPSAVE"],
	["Qilin Minigun", "O_T_LSV_02_armed_F", 60000, "vehicle", "SKIPSAVE"],
	...
	["Ifrit HMG", "O_MRAP_02_hmg_F", 150000, "vehicle"],
	["Ifrit GMG", "O_MRAP_02_gmg_F", 175000, "vehicle"],
...
[
	...
	["M-900 Civilian", "C_Heli_Light_01_civil_F", 40000, "vehicle"], // MH-6, no flares
	["MH-9 Hummingbird", "B_Heli_Light_01_F", 50000, "vehicle"], // MH-6
	["PO-30 Orca (Unarmed)", "O_Heli_Light_02_unarmed_F", 60000, "vehicle"], // Ka-60
	["WY-55 Hellcat (Unarmed)", "I_Heli_light_03_unarmed_F", 70000, "vehicle"], // AW159
	["CH-49 Mohawk", "I_Heli_Transport_02_F", 80000, "vehicle"], // AW101

	["Mi-290 Taru (Resupply)", "O_Heli_Transport_04_ammo_F", 75000, "vehicle"],
	["Mi-290 Taru (Crane)", "O_Heli_Transport_04_F", 75000, "vehicle"], // CH-54
	["Mi-290 Taru (Box)", "O_Heli_Transport_04_box_F", 80000, "vehicle"],
	["Mi-290 Taru (Fuel)", "O_Heli_Transport_04_fuel_F", 85000, "vehicle"],
	["Mi-290 Taru (Bench)", "O_Heli_Transport_04_bench_F", 90000, "vehicle"],
	["Mi-290 Taru (Transport)", "O_Heli_Transport_04_covered_F", 95000, "vehicle"],
	...
	["CH-67 Huron (Unarmed)", "B_Heli_Transport_03_unarmed_F", 100000, "vehicle"], // CH-47
...
[
	["Caesar BTT", "C_Plane_Civil_01_F", 25000, "vehicle"],
	...
	["MQ4A Greyhawk Cluster UAV", "B_UAV_02_dynamicLoadout_F", 150000, "vehicle", "variant_greyhawkCluster"],
	["K40 Ababil-3 Cluster UAV", "O_UAV_02_dynamicLoadout_F", 150000, "vehicle", "variant_greyhawkCluster"],
	["K40 Ababil-3 Cluster UAV", "I_UAV_02_dynamicLoadout_F", 150000, "vehicle", "variant_greyhawkCluster"],
	...
	["UCAV Sentinel Cluster", "B_UAV_05_F", 200000, "vehicle", "variant_sentinelCluster"]
];
...
[
	...
	["Rescue Boat", "C_Rubberboat", 5000, "boat", "SKIPSAVE"],
	["Rescue Boat (NATO)", "B_Lifeboat", 5000, "boat", "SKIPSAVE"],
	["Rescue Boat (CSAT)", "O_Lifeboat", 5000, "boat", "SKIPSAVE"],
	["Assault Boat (NATO)", "B_Boat_Transport_01_F", 6000, "boat", "SKIPSAVE"],
	["Assault Boat (CSAT)", "O_Boat_Transport_01_F", 6000, "boat", "SKIPSAVE"],
	["Assault Boat (AAF)", "I_Boat_Transport_01_F", 6000, "boat", "SKIPSAVE"],
	["Assault Boat (FIA)", "B_G_Boat_Transport_01_F", 6000, "boat", "SKIPSAVE"],
	["Motorboat", "C_Boat_Civil_01_F", 10000, "boat", "SKIPSAVE"],
	["Motorboat Rescue", "C_Boat_Civil_01_rescue_F", 9000, "boat", "SKIPSAVE"],
	["Motorboat Police", "C_Boat_Civil_01_police_F", 11000, "boat", "SKIPSAVE"],

	["RHIB", "I_C_Boat_Transport_02_F", 12500, "boat", "SKIPSAVE"],
	...
	["SDV Submarine (NATO)", "B_SDV_01_F", 10000, "submarine", "SKIPSAVE"],
	["SDV Submarine (CSAT)", "O_SDV_01_F", 10000, "submarine", "SKIPSAVE"],
	["SDV Submarine (AAF)", "I_SDV_01_F", 10000, "submarine", "SKIPSAVE"]
];
